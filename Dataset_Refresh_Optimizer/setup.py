...
setup(
    ...
    #    src/qs_ds_refresh_optimizer/cli.py
    #    For convenience I usually recommend calling it main()
    #
    # 2. Uncomment this section of the setup.py arguments; this will create
    #    bin/Qs-ds-refresh-optimizer (which you can obviously change!) as a script
    #    that will call your main() function, above.
    #
    # entry_points="""\
    # [console_scripts]
    # Qs-ds-refresh-optimizer = qs_ds_refresh_optimizer.cli:main
    # """,
    #
